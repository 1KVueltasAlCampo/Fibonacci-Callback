...
{
    default void response(String rs)
    {
        response(rs, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void response(String rs, java.util.Map<String, String> context)
    {
        _iceI_responseAsync(rs, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> responseAsync(String rs)
    {
        return _iceI_responseAsync(rs, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> responseAsync(String rs, java.util.Map<String, String> context)
    {
        return _iceI_responseAsync(rs, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_responseAsync(String iceP_rs, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "response", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeString(iceP_rs);
                 }, null);
        return f;
    }
