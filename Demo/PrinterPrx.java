...
{
    default void printString(String s, String hostname)
    {
        printString(s, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void printString(String s, String hostname, java.util.Map<String, String> context)
    {
        _iceI_printStringAsync(s, hostname, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> printStringAsync(String s, String hostname)
    {
        return _iceI_printStringAsync(s, hostname, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> printStringAsync(String s, String hostname, java.util.Map<String, String> context)
    {
        return _iceI_printStringAsync(s, hostname, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_printStringAsync(String iceP_s, String iceP_hostname, java.util.Map<String, String> context, boolean sync)
    {
